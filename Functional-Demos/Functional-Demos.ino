...
// Define pin numbers and constants for easy reference
#define PIN         15 // Pin number for the NeoPixel
#define LED         9  // Pin number for the onboard LED
#define POWER_EN    22 // Pin number for the power enable
#define ENC_SW      21 // Pin number for the encoder switch

// Device power 
#define POWER_ON  digitalWrite(POWER_EN, HIGH);
#define POWER_OFF  digitalWrite(POWER_EN, LOW);
...
char ssid[] = "STUDIO_L";             // your network SSID (name)
char pass[] = "hackney!clouds24";    // your network password (use for WPA, or use as key for WEP)
int keyIndex = 0;    
...
void setup() {
  ...
  Serial.println("Eink display setup"); 
  ...
  Serial.println("Setup Wifi"); // Debug message
...
void loop() {
  ...
  Serial.println("Loop start"); // Debug message

  Serial.println("Test wifi"); // Debug message
  ...
  if (!client.connected()) {
    ...
    Serial.println("Turn led on"); // Debug message
    LED_ON;
    delay(2000);

    Serial.println("Turn led off"); // Debug message
    LED_OFF;
    delay(2000);
    ...
    pixels.show();  
    Serial.println("Pixel set to white"); 
    delay(2000);
    ...
    if (!counter){
      LED_ON; // Turn the onboard LED on when the counter reaches 0
      POWER_OFF; // Turn off the power
      Serial.println("Counter reached zero, LED on, power off"); // Debug message
    }
...
void displayDemo() {
    ...
    Serial.println("Fast picture  display"); 
...
//////////////////////Partial refresh digital presentation//////////////////////////////////////  
  ...
  ////////////////////////////////////////////////////////////////////////  
    ...
    Serial.println("End display function?"); 
